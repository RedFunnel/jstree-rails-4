 ...
 */
	...
	$.jstree.core.prototype = {
		...
		rename_node : function (obj, val) {
			...
			// 2016-06-21 GMB - Fix HTML encoding issues.
		      if (obj.a_attr["append_on_rename"] != undefined)
		        	this.set_text(obj, val + obj.a_attr["append_on_rename"]);
		...
		edit : function (obj, default_text) {
			...
			// 2016-06-21 GMB - Fix HTML encoding issues.
			default_text = $('<textarea/>').html(default_text).text();

			if ( obj.a_attr["append_on_rename"] != undefined)
				default_text = default_text.replace( obj.a_attr["append_on_rename"], '');
